...
#Now to test the algorithm, I'm gonna remove some random lines from the data we have.

# With the remaining data we will train the algorithm, if the real values from the data and algorithm matches then we can say that our algorithm is working right.
remove = [0,25,50,100]
